...
// ── exportToPDF ───────────────────────────────────────────────────────────────
export function exportToPDF(rows, columns, title, filename, subtitle = '', generatedBy = '') {
...
doc.autoTable({
    ...
    didDrawPage(data) {
      ...
      doc.text(`Report Generated On: ${now.toLocaleDateString('en-IN', {day:'2-digit',month:'long',year:'numeric'})}  ${now.toLocaleTimeString('en-IN', {hour:'2-digit',minute:'2-digit',hour12:true})}`, 14, pageH - 4.5);
